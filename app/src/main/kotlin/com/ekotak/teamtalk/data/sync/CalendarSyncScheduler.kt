...
import com.ekotak.teamtalk.worker.CalendarSyncWorker
import dagger.hilt.android.qualifiers.ApplicationContext
import javax.inject.Inject
import javax.inject.Singleton

/**
 * Zleca opróżnienie kolejki zmian kalendarza. Wydzielone z repozytorium, żeby
 ...
 * telefon wróci w zasięg. `KEEP` pilnuje, by kilka zmian pod rząd (przesunięcie
 * trzech wizyt w aucie) nie zamawiało trzech przebiegów.
 */
@Singleton
